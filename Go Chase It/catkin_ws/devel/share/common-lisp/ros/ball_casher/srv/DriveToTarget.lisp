...
(cl:defmethod cl:initialize-instance :after ((m <DriveToTarget-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DriveToTarget-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ball_casher-srv:<DriveToTarget-request> is deprecated: use ball_casher-srv:DriveToTarget-request instead.")))

(cl:ensure-generic-function 'linear_x-val :lambda-list '(m))
(cl:defmethod linear_x-val ((m <DriveToTarget-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ball_casher-srv:linear_x-val is deprecated.  Use ball_casher-srv:linear_x instead.")
  (linear_x m))

(cl:ensure-generic-function 'angular_z-val :lambda-list '(m))
(cl:defmethod angular_z-val ((m <DriveToTarget-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ball_casher-srv:angular_z-val is deprecated.  Use ball_casher-srv:angular_z instead.")
  (angular_z m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<DriveToTarget-request>)))
  ...
  "ball_casher/DriveToTargetRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'DriveToTarget-request)))
  "Returns string type for a service object of type 'DriveToTarget-request"
  "ball_casher/DriveToTargetRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <DriveToTarget-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DriveToTarget-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ball_casher-srv:<DriveToTarget-response> is deprecated: use ball_casher-srv:DriveToTarget-response instead.")))

(cl:ensure-generic-function 'msg_feedback-val :lambda-list '(m))
(cl:defmethod msg_feedback-val ((m <DriveToTarget-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ball_casher-srv:msg_feedback-val is deprecated.  Use ball_casher-srv:msg_feedback instead.")
  (msg_feedback m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<DriveToTarget-response>)))
  ...
  "ball_casher/DriveToTargetResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'DriveToTarget-response)))
  "Returns string type for a service object of type 'DriveToTarget-response"
  "ball_casher/DriveToTargetResponse")
